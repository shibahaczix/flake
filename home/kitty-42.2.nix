...
, wayland-protocols, wayland, xxHash, nerd-fonts, lcms2, librsync, openssl
...
buildPythonApplication rec {
  ...
  buildInputs =
    [ harfbuzz ncurses simde lcms2 librsync matplotlib openssl.dev xxHash ]
    ++ lib.optionals stdenv.hostPlatform.isDarwin [ libpng python3 zlib ]
  ...
  meta = with lib; {
    ...
    mainProgram = "kitty";
    maintainers = with maintainers; [ tex rvolosatovs Luflosi kashw2 leiserfg ];
  };
}
